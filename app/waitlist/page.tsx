...
export default function Waitlist() {
  ...
  return (
    <main>
      ...
      <section className="z-10 relative min-h-screen flex flex-col justify-center items-center">
        <form
          onSubmit={handleSubmit(onSubmit)}
          className="bg-white bg-opacity-90 backdrop-blur-md p-8 rounded-lg shadow-lg w-full max-w-md border border-black space-y-3"
        >
